<template>
	<view style="padding-bottom: 100upx;">
		...
		<view class="padding" :style="[{ paddingTop: CustomBar + 'px' }]">
			...
			<view class="padding">
				<!-- #endif -->
				<view class="title" :style="{color: plant_detail.color, fontSize: plant_detail.size}"><image :src="plant_detail.icon" style="margin-right: 12upx; width: 36upx; height: 36upx; line-height: 36upx; border-radius: 50%;" v-if="plant_detail.icon"></image><text style="margin-right: 12upx;" v-if="!plant_detail.icon">♨</text>{{ plant_detail.title ||''}}</view>
				...
				<swiper class="screen-swiper" :indicator-dots="true" :circular="true" :autoplay="true" interval="2000"
					duration="500" v-if="plant_detail.video_id || plant_detail.img_url.length"
					style="height: 500upx;">
					...
					<swiper-item v-for="(item, index) in plant_detail.img_url" v-if="plant_detail.img_url.length "
				...
				<view class="mt10 f32" v-if="plant_detail.phone_content">
				...
				<view class=" f32" v-if="plant_detail.driver_name!=''">
			...
			<!-- #ifndef H5 -->
			<view class="bg-white pb50" style="border-top: 1px solid #EEEEEE;" v-if="type != 20221015">
				<view class="bg-white">
			...
			<view class="cu-bar foot search bg-white" style="border-top: 1px solid #EEEEEE;" v-if="type != 20221015">
