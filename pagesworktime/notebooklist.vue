	...
	<view class="padding brt_e" style="height: 100%;">
		<view class=" flex align-center justify-between fixed bg-white">
			<view class="inputBox flex align-center padding">
				...
				<input type="text" value="" placeholder="请输入关键词" placeholder-style="color:#999999;font-size:24rpx;" @confirm="search_input" v-model="keyword" />
			</view>
			<view class="flex_shrink padding-left-sm" @tap="search_input">搜索</view>
		</view>

		<view class="pb20 pt20" v-if="newsList != ''" style="padding-top: 100upx;">
			<view
				class="mb20"
		...
		<view style="width: 60%; height: 128upx; display: flex; justify-content: space-around; align-items: center; position: fixed; left: 20%; bottom: 50upx; z-index: 20190118;">
			<view
...
export default {
	...
	onLoad(e) {
		// 此处默认指定为记事本的category_id即可，已经在后台添加了【记事本（请勿编辑/删除）】，category_id为12。
